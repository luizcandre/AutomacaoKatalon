...
class RadarLive {
	...
	def abrirURL(DataTable data){
		funcionalidadesAuto.RadarLiveFuncionalidades.lerDataTable(data)
	}

	@Then('verifico se não existem diferenças no cálculo dos pacotes da tela "2. Preço"')
	def preencherCamposObrigatoriosDaTelaPreco(){
		funcionalidadesAuto.RadarLiveFuncionalidades.preencherCamposObrigatoriosDaTelaPreco()
	}
}